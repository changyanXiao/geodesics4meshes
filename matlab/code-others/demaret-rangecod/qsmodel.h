...
typedef struct {
    ...
    uint2 *cf,         /* array of cumulative frequencies */
        *newf,         /* array for collecting statistics */
...
void qsgetsymcont( qsmodel *m, int lt_f, int LocalMax, int* Value );
void qsgetsymcont( qsmodel *m, int lt_f, int LocalMin,int LocalMax, int* Value );
void qsgetsymcomb( qsmodel *m, int lt_f, double proba0, int* Value );
//void qsgetcombmult( qsmodel *m, int lt_f, double* proba);
void qsgetcombmult( qsmodel *m, int lt_f, double* proba, int* Value);
