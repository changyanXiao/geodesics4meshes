function [Q,DQ, voronoi_edges, edges_id, lambda] = compute_voronoi_aniso_mesh(vertex,faces, start_points, options)

% compute_voronoi_aniso_mesh - compute the exact voronoi segmentation of a 3D mesh
%
...
%
%   See also perform_Aniso_Eikonal_Solver_mesh.
%
%   Copyright (c) 2010 Gabriel Peyre & Fethallah Benmansour
