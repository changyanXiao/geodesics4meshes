function [D,VarX, VarY, VarZ] = perform_Eikonal_Solver_Variation_mesh(vertex, faces, start_points, options)
...
if exist('perform_front_propagation_2d')~=0
    [D,VarX, VarY, VarZ] = EikonalSolverMeshVariation(vertex-1, faces-1, W,start_points-1,end_points-1, nb_iter_max, H, L, values, dmax);
else
