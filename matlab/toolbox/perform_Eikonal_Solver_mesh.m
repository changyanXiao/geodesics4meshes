function [D,Q] = perform_Eikonal_Solver_mesh(vertex, faces, start_points, options)
...
if exist('perform_front_propagation_2d', 'file')~=0
    [D,Q] = EikonalSolverMesh(vertex-1, faces-1, W,start_points-1,end_points-1, nb_iter_max, H, L, values, dmax);
    Q = Q+1;
else
